...
class BusTimeWidget:
    def __init__(self, frame):
        ...
        wait_time_label = tk.Button(self.frame_button, text="15 min", font=('Roboto', 80, 'bold'), command=self.clear)
